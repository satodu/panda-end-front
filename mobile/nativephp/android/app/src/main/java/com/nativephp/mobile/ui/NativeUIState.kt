...
object NativeUIState {
    ...
    // Fullscreen state - hides native bars and overrides padding to zero
    private val _hideNativeBars = mutableStateOf(false)
    val hideNativeBars: State<Boolean> = _hideNativeBars

    fun setHideNativeBars(hide: Boolean) {
        _hideNativeBars.value = hide
    }
